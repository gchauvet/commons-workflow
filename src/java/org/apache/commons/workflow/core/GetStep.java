...
/**
 * <p>For each associated <code>Descriptor</code>, make a copy of the
 * specified Java object and push it on to the evaluation stack, in the
 * order that descriptors are listed.</p>
 *
 * @version $Revision$ $Date$
 * @author Craig R. McClanahan
 */

public class GetStep extends DescriptorStep {
     ...
     */
    public GetStep(String id, Descriptor descriptor) {
