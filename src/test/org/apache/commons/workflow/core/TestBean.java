...
/**
 * General purpose test bean for core <code>Step</code> implementation tests.
 *
...
public class TestBean {
     ...
     *
     * @param stringProperty Custom value for stringProperty
     * @param intProperty Custom value for intProperty
     */
    public TestBean(String stringProperty, Integer intProperty) {

        super();
        this.stringProperty = stringProperty;
        this.intProperty = intProperty.intValue();
